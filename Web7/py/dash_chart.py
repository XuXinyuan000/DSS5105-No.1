...
# 读取数据文件
data = pd.read_csv(r"D:\DSS\DSS5105\Web6\data\Final_score.csv")
...
T_layout = html.Div([
    dcc.Graph(
        figure=px.bar(data, x='Company Name', y='Total ESG Score', color_discrete_sequence=['#6699FF'])##FF99CC这是一种粉色#6699FF这是一种蓝色'#A3A7A9'这是一种灰蓝色
